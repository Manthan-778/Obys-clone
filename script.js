...
var footerH1= document.querySelector("#footer>h1").addEventListener("mousemove",function(){
    gsap.from("#footer>h1",{
        opacity:1,
        delay:0.5,
        duration:1,
